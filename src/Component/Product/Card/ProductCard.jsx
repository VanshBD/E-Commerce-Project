      ...
      <div className="container-fluid">
        ...
        {!loading && !error && (
          <div>
            ...
            {data
              .filter(categoryData => categoryData.category !== "Clothes")
              .filter(categoryData => categoryData.product && categoryData.product.length > 0)
              .map((categoryData) => (
                <div key={categoryData.category}>
                  ...
                  <div className="row justify-content-center px-4">
                    {categoryData.product.map((product) => (
                      <div key={product.id} className="col-lg-3 col-md-4 col-sm-6 mb-3 mt-3 p-3">
